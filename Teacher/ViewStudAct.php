...
mysql_select_db($database_system, $system);
$query_act = "SELECT * FROM activities";
...
<title>View Activity Progress</title>
...
<h1 id="name1">Welcome,  <?php echo $row_u['fn']; ?>!</h1>
 ...
 <div class="dropdown">
  ...
  <tr>
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <table width="100%" align="center"  cellpadding="10" cellspacing="10" style="margin-left:10%;">
      <tr id="actCat">
        <td width="150"  height="21"id="tdHeader">Lesson</td>
        <td width="300" id="tdHeader">Name</td>
        <td width="150" id="tdHeader">Total Items</td>
        <td width="150" id="tdHeader">Date Taken</td>
 
      </tr><?php do { ;?>
      <tr id="trContent">
      	
        <td><?php echo $row_act['Lesson'];?></td>
        <td><?php echo $row_act['Actname']; ?></td>
        <td><?php echo $row_act['NoItems']; ?></td>
        <td><?php echo $row_act['DateIn']; ?></td>
        <td><a href="/Teacher/ViewGrade1.php?ActNo=<?php echo $row_act['ActNo']; ?>">Students grades</a></td>
      </tr>
      <?php } while ($row_act = mysql_fetch_assoc($act));?>
      </table>
      <a id="extra" href="AddGrade.php">Extra Activity</a>
      <br />
<br />
