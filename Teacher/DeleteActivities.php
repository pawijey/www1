...
mysql_select_db($database_system, $system);
$query_act = sprintf("SELECT * FROM activities WHERE ActID = %s", GetSQLValueString($colname_act, "int"));
    ...
    <td height="800" align="center" ><p>&nbsp;</p>
      ...
      <tr>
        <td width="702" align="center"><font size="10">Are you sure do you want to remove this record?</font></td>
              ...
              <tr><?php do { ;?>
                <td align="center" style="padding-left:41%;"><a href="DeleteActivities1.php?ActID=<?php echo $row_act['ActID'];?>"><strong>Yes</strong></a><strong><a href="javascript:history.go(-1)">No</a></strong></td>
              </tr><?php } while ($row_act = mysql_fetch_assoc($act));?>
