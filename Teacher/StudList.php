...
mysql_select_db($database_system, $system);
$query_my = sprintf("SELECT * FROM mystudents WHERE username = %s ORDER BY id ASC", GetSQLValueString($colname_my, "text"));
...
<h1 id="name1">Welcome, <?php echo $row_u['fn']; ?>!</h1>
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="StudList.php"style="color:gray; cursor: default;"><img src="/image/icons/PixelMixer/folder.ico" width="16" height="16" />Student List</a>
 ...
 <div class="dropdown">
  ...
  <tr>
    <td height="800" align="center" id="tdMain" >
      ...
      <table width="850">
      <tr>
        <td width="564"id="tdLessonR">LIST OF YOUR STUDENTS:</td>
      </tr>
      <tr>
        <td align="center">
        <table width="850" cellspacing="10" cellpadding="3">
          <tr>
              <td width="516" align="center" id="tdCatLs">Student Name</td>
              <td width="65" align="center" id="tdCatLs">Profile</td>
            </tr>
            <?php do { ?>
              <tr>
                <td align="center" id="tdLsR"><font size="5"><?php echo $row_my['fn']," ", $row_my['mi']," ", $row_my['ln']; ?></font></td>
                <td align="center" id="tdLsR"><img src="../Student/image/<?php echo $row_my['picture']; ?>" alt="" width="65" height="65" /></td>
                <td align="center" id="tdLsR"><a id="linkView"href="StudDel.php?id=<?php echo $row_my['id'];?>"><img src="../image/trash.png" width="31" height="36" /></a></td>
              </tr>
