...
<h1 id="name1">Welcome, <?php echo $row_u['fn']; ?>!</h1>
 ...
 <div class="dropdown">
   ...
   <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="ViewStudQz.php"style="color:gray; cursor: default;"><img src="/image/icons/PixelMixer/folder.ico" width="16" height="16" />Quizzes</a>
  ...
  <tr>
    <td height="800" align="center" id="tdMain" >
          ...
          <table width="100%" align="center" cellspacing="10" cellpadding="10" style="margin-left:10%; margin-top:5%;">
              <tr id="qzCat">
                <td width="200" align="center" id="tdHeader">Quiz Number</td>
                <td width="500" align="center" id="tdHeader">Quiz Name</td>
                <td width="200" align="center"id="tdHeader">Date Taken</td>
                <td width="200" align="center"id="tdHeader">Total Items</td>

              </tr>
              <?php do { ?>
                <tr id="qzCatRd">
                  <td align="center"><?php echo $row_qz['QzNo']; ?></td>
                  <td align="center"><?php echo $row_qz['Qzname']; ?></td>
                  <td align="center"><?php echo $row_qz['DateIn']; ?></td>
                  <td align="center"><?php echo $row_qz['NoItems']; ?></td>
                  <td align="center"><a href="/Teacher/ViewGrade2.php?QzNo=<?php echo $row_qz['QzNo']; ?>">Students grades</a></td>
                </tr>
