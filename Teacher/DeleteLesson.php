    ...
    <td height="800" align="center" id="tdMain" ><p>&nbsp;</p>
      ...
      <tr>
        ...
        <table width="800" align="center">
            <?php do { ?>
              <tr>
                <td width="294" align="center" ><video width="150" height="100" controls>
                  <source src="../MathLessonsMp4/Lessons/<?php echo $row_les['file']; ?>" type="video/ogg">   
                </video></td>
              </tr>
              <tr>
                <td align="center" ><font size="10"><?php echo $row_les['title']; ?></font></td>
              </tr>
              <tr>
                <td align="center" ><font size="5"><?php echo $row_les['subject']; ?></font></td>
              </tr>
              <tr>
                <td align="center" id="links" ><a href="DeleteLesson1.php?id=<?php echo $row_les['id'];?>"><strong>Yes</a> <strong><a href="javascript:history.go(-1)">No</a></strong></td>
              </tr>
