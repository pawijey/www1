...
mysql_select_db($database_system, $system);
$query_actans = sprintf("SELECT *,  sum(IF (a = answer, '1', '0')) as A FROM actanswer WHERE ActNo = %s GROUP BY username ORDER BY username ASC", GetSQLValueString($colname_actans, "text"));
  ...
  <tr>
    ...
    <table width="100%"  cellpadding="10" cellspacing="10" align="center" style="border-collapse:collapse">
      ...
      <tr id="trContent">
        ...
        <td><?php echo $row_actans['username']; ?></td>
        <td><?php echo $row_actans['ActNo']; ?></td>
        <td><?php echo $row_actans['itemNo']; ?></td>
        <td><?php echo $row_actans['DateIn']; ?></td>
        <td><?php echo $row_actans['A'];?></td>
        
      </tr><?php } while ($row_actans = mysql_fetch_assoc($actans));?>
      </table>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
