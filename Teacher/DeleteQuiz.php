...
<h1 id="name1">Welcome, <?php echo $row_u['fn']; ?>!</h1>
 ...
 <div class="dropdown">
  ...
  <tr>
    <td height="800" align="center" ><p>&nbsp;</p>
      <table width="710" align="center">
      <tr>
        <td width="702" align="center"><font size="10">Are you sure do you want to remove this record?</font></td>
      </tr>

              <tr><?php do { ;?>
                <td align="center" style="padding-left:41%;"><a href="DeleteQuiz1.php?QzID=<?php echo $row_qz['QzID'];?>"><strong>Yes</strong></a><strong><a href="javascript:history.go(-1)">No</a></strong></td>
              </tr><?php } while ($row_qz = mysql_fetch_assoc($qz));?>
