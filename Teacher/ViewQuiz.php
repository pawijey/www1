...
$colname_vquiz = "-1";
if (isset($_SESSION['MM_Username'])) {
  $colname_vquiz = $_SESSION['MM_Username'];
}
mysql_select_db($database_system, $system);
$query_vquiz = sprintf("SELECT * FROM quiz WHERE username = %s", GetSQLValueString($colname_vquiz, "text"));
$vquiz = mysql_query($query_vquiz, $system) or die(mysql_error());
$row_vquiz = mysql_fetch_assoc($vquiz);
$totalRows_vquiz = mysql_num_rows($vquiz);
...
<h1 id="name1">Welcome, <?php echo $row_u['fn']; ?>!</h1>
 ...
 <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="ViewQuiz.php"style="color:gray; cursor: default;"><img src="/image/icons/PixelMixer/folder.ico" width="16" height="16" />View Quiz</a>
  ...
  <tr>
    ...
    <table width="958" border="0" align="center" cellspacing="15">
      <tr>
        <td width="88" id="tdCatLs">QUIZ #</td>
        <td width="103" id="tdCatLs">LESSON #</td>
        <td width="103" id="tdCatLs">TOTAL ITEMS</td>
        <td width="99" id="tdCatLs">TEACHER</td>
        <td width="147" id="tdCatLs">DATE START</td>
        <td width="146" id="tdCatLs">DUE DATE</td>
        <td width="140" id="tdCatLs">SCHOOL YEAR</td>
        </tr>
        <?php do { ?>
      <tr class="tdPhp">

        <td id="tdLsR"><?php echo $row_vquiz['QzNo']; ?></td>
        <td id="tdLsR"><?php echo $row_vquiz['Lesson']; ?></td>
        <td id="tdLsR"><?php echo $row_vquiz['NoItems']; ?></td>
        <td id="tdLsR"><?php echo $row_vquiz['Teacher']; ?></td>
        <td id="tdLsR"><?php echo $row_vquiz['DateIn']; ?></td>
        <td id="tdLsR"><?php echo $row_vquiz['DateOut']; ?></td>
        <td id="tdLsR"><?php echo $row_vquiz['sy']; ?></td>
        <td ><a id="linkView"href="DeleteQuiz.php?QzID=<?php echo $row_vquiz['QzID'];?>"><img src="/image/icons/VistaIco/Symbol-Delete.ico" alt="DeleteQuiz" width="25" height="25" /></a></td>
        </tr>
        <?php } while ($row_vquiz = mysql_fetch_assoc($vquiz)); ?>
    </table>
