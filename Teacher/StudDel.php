...
mysql_select_db($database_system, $system);
$query_my = sprintf("SELECT * FROM mystudents WHERE id = %s", GetSQLValueString($colname_my, "int"));
      ...
      <tr>
        ...
        <table width="800" align="center">
            <?php do { ?>
              ...
              <tr>
                <td align="center" id="links" ><a href="StudDel2.php?id=<?php echo $row_my['id'];?>"><strong>Yes</a> <strong><a href="javascript:history.go(-1)">No</a></strong></td>
              </tr>
