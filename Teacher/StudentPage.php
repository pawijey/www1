...
<!-- Navbar ends here -->
  <tr>
    ...
    <td height="476" align="center" bgcolor="#FFFFFF" id="tdMain">
    <!-----------------------------------------------------------------------Table Quizzes starts here ------------------------------------------------------------>
      <table width="200" id="tableQuiz">
        <tr>
          <td align="center" bordercolor="black">
		  <?php if ($row_QzBar['Qz'] == 5) echo '<img src="../image/starusbar/bar0.png" width="276" height="27" />';
		  ...
		  elseif ($row_QzBar['Qz'] == 25)  echo '<img src="../image/starusbar/bar4.png" width="276" height="27" />';  
        ...
        <tr>
          ...
          <table width="600" align="center" cellspacing="10">
              <tr id="qzCat">
                <td width="71" align="center" id="tdQzC">QuizNo</td>
                <td width="276" align="center" id="tdQzC">Date Taken</td>
                <td width="78" align="center"id="tdQzC">Total Items</td>
...
Records  <?php echo min($startRow_qz + $maxRows_qz, $totalRows_qz) ?> of <?php echo $totalRows_qz ?></td>
        </tr>
        <tr>
          <td height="9"><table border="0">
              <tr>
                <td align="center"><?php if ($pageNum_qz > 0) { // Show if not first page ?>
...
<!-----------------------------------------------------------------------Table Activities starts here ------------------------------------------------------------>
      <table width="200" cellspacing="5" id="tableAct">
        <tr>
          <td align="center" id="tableQuiz">
		  <?php if ($row_AcrBar['Act'] == 16) echo '<img src="../image/starusbar/bar0.png" width="276" height="27" />'; 
		  elseif ($row_AcrBar['Act'] == 32) echo '<img src="../image/starusbar/bar1.png" width="276" height="27" />'; 
		  elseif ($row_AcrBar['Act'] == 48)   echo '<img src="../image/starusbar/bar2.png" width="276" height="27" />' ; 
        ...
        <tr>
          <td>
          <table width="600" align="center" cellspacing="10">
            <tr class="white" id="actCat">
              <td width="100" align="center" id="tdActC">ActNo.</td>
              <td width="200" align="center"id="tdActC">Date Taken</td>
              <td width="86" align="center" id="tdActC">Total Items</td>
              <td width="49" align="center" id="tdActC">Scores</td>
              <td width="97" align="center" id="tdActC">Remarks</td>
            </tr>
            <?php do { ?>
            <tr id="actCatRd">
              <td width="100" align="center" ><?php echo $row_act['ActNo']; ?></td>
        ...
        <tr>
          <td align="center">&nbsp;
Records <?php echo min($startRow_act + $maxRows_act, $totalRows_act) ?> of <?php echo $totalRows_act ?></td>
        </tr>
        <tr>
          <td><table border="0">
            <tr>
              <td align="center"><?php if ($pageNum_act > 0) { // Show if not first page ?>
