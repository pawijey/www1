 ...
 <div class="dropdown">
  ...
  <tr>
    <td height="435" align="center" bgcolor="#FFFFFF"  ><p>&nbsp;</p>
      ...
      <tr>
        <td align="center"><table width="304">
            <?php do { ?>
              <tr>
                <td width="294" align="center" bgcolor="#CCCCCC"><img src="../Student/image/<?php echo $row_my['picture']; ?>" alt="" width="98" height="120" /></td>
                </tr>
              <tr>
                <td align="center" bgcolor="#CCCCCC"><?php echo $row_my['id']; ?></td>
                </tr>
              <tr>
                <td align="center" bgcolor="#CCCCCC"><font size="5"><?php echo $row_my['fn']," ", $row_my['mi']," ", $row_my['ln']; ?></font></td>
                </tr>
              <tr>
                <td align="center">Yes | <a href="StudList.php">No</a></td>
              </tr>
