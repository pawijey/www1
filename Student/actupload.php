...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO actup (id, username, actid, actno, DateIn, DateOut, teacher, upfile) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "/Student/TakeActivities1.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if(isset($_FILES['file'])){
		...
		$expensions= array("docx","doc","wps","pdf"); 		
		...
		if(empty($errors)==true){
			move_uploaded_file($file_tmp,"Teacher/upload/".$file_name);
			echo "Success";
		}else{
			print_r($errors);
		}
        ...
        <tr>
         ...
         <tr>
        	<td align="center"><strong><font size="6">Activity <?php echo $row_act['actno'];?>:</font> <font size="7" color=" green"><?php echo $row_act['actname'];?></strong></font><br />
            	<a href="/Student/actupload.php?actno=<?php echo $row_act1['actno']; ?>">Take Activity</a></td>
        </tr>
      <tr>
...
$max_size = 32000;          // maximum file size, in KiloBytes
$allowtype = array('docx', 'doc', 'wps', 'pdf');        // allowed extensions
...
if(isset($_FILES['fileup']) && strlen($_FILES['fileup']['name']) > 1) {
  ...
  if($err == '') {
	...
	echo 'Your File: <b>'. basename( $_FILES['fileup']['name']). '</b> is Successfully uploaded!';
      echo '<br/>Please wait for your teacher to grade your work';
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="DateIn" value="<?php echo date("m/d/y h:i:s");?>"  readonly="readonly"/></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="actid" value="<?php echo $row_act['actid']; ?>" />
  <input type="hidden" name="actno" value="<?php echo $row_act['actno']; ?>" />
  <input type="hidden" name="DateOut" value="<?php echo $row_act['DateOut']; ?>" />
  <input type="hidden" name="teacher" value="<?php echo $row_act['teacher']; ?>" />
  <input type="hidden" name="upfile" value="<?php echo ($_FILES['fileup']['name']); ?>" />
...
<br />
      ...
      <tr>
        <td align="center"><a href="javascript:history.back()">Go Back</a></td>
        </tr>
    </table>
    </td>
  </tr>
