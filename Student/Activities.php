  ...
  <tr>
    <td height="100%" align="center" id="tdMain" ><p>&nbsp;</p>
      ...
      <tr>
        ...
        <table width="100%" align="center" cellpadding="5" cellspacing="15">
            <tr id="qzCat">
              ...
              <td width="80" align="center"  id="tdQzC">Total Items</td>
            ...
            <?php do { ?>
              <tr id="qzCatRd">
                ...
                <td align="center" id="tdLsR" ><?php echo $row_act['NoItems']; ?></td>
                <td align="center" id="tdLsR" ><a href="TakeActivities.php?ActNo=<?php echo $row_act['ActNo'];?>">
      ...
      <tr>
        ...
        <table border="0">
          <tr>
              <td><?php if ($pageNum_act > 0) { // Show if not first page ?>
                  <a href="<?php printf("%s?pageNum_act=%d%s", $currentPage, max(0, $pageNum_act - 1), $queryString_act); ?>">
                  <img src="/image/icons/previous.png" width="16" height="16" /></a>
                <?php } // Show if not first page ?></td>
              <td><?php if ($pageNum_act < $totalPages_act) { // Show if not last page ?>
                  <a href="<?php printf("%s?pageNum_act=%d%s", $currentPage, min($totalPages_act, $pageNum_act + 1), $queryString_act); ?>">
                  <img src="/image/icons/next.png" width="16" height="16" /></a>
                <?php } // Show if not last page ?></td>
              <td><?php if ($pageNum_act > 0) { // Show if not first page ?>
                  <a href="<?php printf("%s?pageNum_act=%d%s", $currentPage, 0, $queryString_act); ?>">
                  <img src="/image/icons/first.png" width="16" height="16" /></a>
                <?php } // Show if not first page ?></td>
              <td><?php if ($pageNum_act < $totalPages_act) { // Show if not last page ?>
                  <a href="<?php printf("%s?pageNum_act=%d%s", $currentPage, $totalPages_act, $queryString_act); ?>">
                  <img src="/image/icons/last.png" width="16" height="16" /></a>
                <?php } // Show if not last page ?></td>
            </tr>
            <tr>
            	<td>
        ...
        </table>&nbsp;&nbsp;<?php if ($row_Qstn['Tot'] == 10) echo'<a href="/Student/Activities1.php">Extra Activities</a>';?>
        </td>
      </tr>
    </table>
      <p>&nbsp;</p>
