...
$colname2_qz1 = "-1";
if (isset($_GET['QzNo'])) {
  $colname2_qz1 = $_GET['QzNo'];
}
mysql_select_db($database_system, $system);
$query_qz1 = sprintf("SELECT * FROM quiz WHERE username = %s and QzNo = %s ", GetSQLValueString($colname_qz1, "text"),GetSQLValueString($colname2_qz1, "text"));
...
$colname1_ans = "-1";
if (isset($_GET['QzNo'])) {
  $colname1_ans = $_GET['QzNo'];
}
mysql_select_db($database_system, $system);
$query_ans = sprintf("SELECT *, IF (a = answer, '1', '0') as A FROM stdqz WHERE username = %s and QzNo = %s", GetSQLValueString($colname_ans, "text"),GetSQLValueString($colname1_ans, "text"));
...
mysql_select_db($database_system, $system);
$query_ans2 = sprintf("SELECT *,  sum(IF (a = answer, '1', '0')) as A FROM stdqz WHERE QzNo = %s and username = %s", GetSQLValueString($colname_ans2, "text"),GetSQLValueString($colname2_ans2, "text"));
...
$colname_qzqtn = "-1";
if (isset($_GET['QzNo'])) {
  $colname_qzqtn = $_GET['QzNo'];
}
mysql_select_db($database_system, $system);
$query_qzqtn = sprintf("SELECT * FROM quest WHERE QzNo = %s", GetSQLValueString($colname_qzqtn, "text"));
$qzqtn = mysql_query($query_qzqtn, $system) or die(mysql_error());
$row_qzqtn = mysql_fetch_assoc($qzqtn);
$totalRows_qzqtn = mysql_num_rows($qzqtn);
...
<!-- Navbar starts here -->
 ...
 <a href="Quiz.php" id="link" style="color:white;">Quiz</a>
 <a href="Activities.php" id="link">Activities</a>
  ...
  <tr>
    <td height="100%" width="100%" align="center" id="tdMain" ><p>&nbsp;</p>
      <table width="100%">
        <tr>
        <td width="337" height="3" align="center" id="tdQuizR">QUIZ #<?php echo $row_ans['QzNo']; ?> RESULT</td>
        </tr>
      <tr>
      ...
      <tr>
        ...
        <table width="100%" align="center" cellspacing="20" cellspadding="10">
            <tr id="actCat">
              <td width="100%" align="center" id="tdActC">Quiz Number</td>
              <td align="center" id="tdActC">Your Answer</td>
              <td align="center" id="tdActC">Remarks</td>
              </tr>
            <?php do { ?>
              <tr>
                <td width="1000" align="center" id="qzCatRd"><?php echo $row_qzqtn['question']; ?></td>
              ...
              <?php } while ($row_ans = mysql_fetch_assoc($ans)and $row_qzqtn = mysql_fetch_assoc($qzqtn)); ?>
          </table>
          </td>
        </tr>
      <tr>
        <td height="29">
        <table width="100%" align="center" style="text-align:center;font-size: 24px;" cellspacing="20">
            <?php do { ?>
              <tr id="actCat">
                <td width="50%" id="tdActC">Total Score:<strong> <?php echo $row_ans2['A']; ?> / 10</strong></td>
     ...
     <a href="/Student/StudentPage.php">Go Home</a>&nbsp;&nbsp;<a href="/Student/Quiz.php">View all Quizzes</a> </td>
  </tr>
