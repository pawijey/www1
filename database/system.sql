...
--
-- Host: localhost
-- Generation Time: Jun 30, 2023 at 03:20 AM
...
(NULL, 'mysql', 'admins', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'mysql', 'admins', 'username', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'mysql', 'admins', 'password', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mysql', 'admins', 'fn', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mysql', 'admins', 'ln', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mysql', 'admins', 'mi', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mysql', 'admins', 'bday', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mysql', 'admins', 'contact', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mysql', 'admins', 'address', 9, NULL, 'NO', 'varchar', 150, 150, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(150)', '', '', 'select,insert,update,references', ''),
(NULL, 'mysql', 'admins', 'email', 10, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mysql', 'admins', 'pic', 11, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mysql', 'admins', 'UserType', 12, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mysql', 'admins', 'dateReg', 13, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'mysql', 'admins', 'status', 14, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
...
(NULL, 'sample', 'product', 'ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'sample', 'product', 'productname', 2, NULL, 'NO', 'varchar', 150, 150, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(150)', '', '', 'select,insert,update,references', ''),
(NULL, 'sample', 'product', 'productprice', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'sample', 'product', 'description', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'sample', 'product', 'image', 5, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'sample', 'product', 'price', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'sample', 'yamino', 'ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'sample', 'yamino', 'username', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'sample', 'yamino', 'password', 3, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'sample', 'yamino', 'firstname', 4, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'sample', 'yamino', 'lastname', 5, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'sample', 'yamino', 'birthday', 6, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'sample', 'yamino', 'email', 7, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'attendance', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'senior', 'attendance', 'studID', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'attendance', 'username', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'attendance', 'grade', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'attendance', 'section', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'attendance', 'sy', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'attendance', 'days', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'attendance', 'present', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'attendance', 'absent', 9, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'attendance', 'class', 10, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'attendance', 'areas', 11, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'attendance', 'lack', 12, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'attendance', 'date', 13, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'attendance', 'lrn', 14, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'faq', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'senior', 'faq', 'username', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'faq', 'password', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'faq', 'name', 4, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'faq', 'grade', 5, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'faq', 'section', 6, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'faq', 'tvl', 7, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'faq', 'message', 8, NULL, 'YES', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'faq', 'dateTime', 9, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
(NULL, 'senior', 'faq', 'stat', 10, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'username', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'teacher', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'subject', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'studID', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'studname', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'grade', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'section', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'sy', 9, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'track', 10, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'semester', 11, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'midterm', 12, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'final', 13, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'remarks', 14, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'adviser', 15, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'lrn', 16, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'grades', 'tvl', 17, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'username', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'teacher', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'subject', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'studID', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'studname', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'grade', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'section', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'sy', 9, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'track', 10, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'semester', 11, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'midterm', 12, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'final', 13, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'remarks', 14, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'non_grades', 'adviser', 15, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'sched', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'senior', 'sched', 'Time', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'sched', 'Mon', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'sched', 'Tue', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'sched', 'Wed', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'sched', 'Thur', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'sched', 'Fri', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'sched', 'Room', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'sched', 'Teacher', 9, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'sched', 'Semester', 10, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'sched', 'SY', 11, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'section', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'senior', 'section', 'section', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'section', 'type', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'stdact', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'senior', 'stdact', 'username', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'stdact', 'ActID', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'stdact', 'ActNo', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'stdact', 'Teacher', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'stdact', 'DateIn', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'stdact', 'DateOut', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'stdact', 'itemNo', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'stdact', 'answer', 9, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'stdact', 'a', 10, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'studID', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'fname', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'mname', 4, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'lname', 5, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'bday', 6, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'age', 7, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'sex', 8, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'address', 9, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'contact', 10, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'grade', 11, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'section', 12, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'sy', 13, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'lrn', 14, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'track', 15, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'semester', 16, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'stat', 17, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'username', 18, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'teacher', 19, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'email', 20, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'strand', 21, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'tvl', 22, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'xname', 23, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'religion', 24, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'father', 25, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'mother', 26, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'tongue', 27, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'psa', 28, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'returned', 29, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'religion2', 30, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'ip', 31, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'ip2', 32, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'password', 33, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'pic', 34, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'reference', 35, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'zip', 36, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'lastGrade', 37, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'lastSY', 38, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'schoolID', 39, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'schlAddress', 40, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'date1stAttndce', 41, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'widLrn', 42, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'guardian', 43, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'schoolName', 44, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'student', 'admission', 45, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'studID', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'fname', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'mname', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'lname', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'bday', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'age', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'sex', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'address', 9, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'contact', 10, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'grade', 11, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'section', 12, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'sy', 13, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'lrn', 14, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'track', 15, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'semester', 16, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'username', 17, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'teacher', 18, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'advicer', 19, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'subject', 20, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'tvl', 21, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'students', 'xname', 22, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'subject', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'senior', 'subject', 'subject', 2, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'subject', 'type', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'user', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'senior', 'user', 'username', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'user', 'password', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'user', 'name', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'user', 'bday', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'user', 'address', 6, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'user', 'contact', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'user', 'email', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'user', 'subject', 9, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'user', 'stat', 10, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'user', 'sex', 11, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'user', 'status', 12, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'user', 'pic', 13, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'user', 'UserType', 14, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'studID', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'username', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'mdiyos', 4, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'mtao', 5, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'mkalik', 6, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'mbansa', 7, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'admitted', 8, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'section', 9, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'eligib', 10, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'mdiyos2', 11, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'mtao2', 12, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'mbansa2', 13, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'com1', 14, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'com2', 15, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'com3', 16, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'com4', 17, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'mdiyos3', 18, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'mdiyos4', 19, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'mtao3', 20, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'mtao4', 21, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'mkalik2', 22, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'mbansa3', 23, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'mbansa4', 24, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'lrn', 25, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'senior', 'values', 'semester', 26, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actanswer', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'system', 'actanswer', 'username', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actanswer', 'ActID', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actanswer', 'ActNo', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actanswer', 'DateIn', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actanswer', 'DateOut', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actanswer', 'Teacher', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actanswer', 'sy', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actanswer', 'itemNo', 9, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actanswer', 'answer', 10, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actanswer', 'a', 11, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'activities', 'ActID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'system', 'activities', 'ActNo', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'activities', 'DateIn', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'activities', 'DateOut', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'activities', 'NoItems', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'activities', 'username', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'activities', 'Teacher', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'activities', 'sy', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'activities', 'Lesson', 9, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'ActID', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'ActNo', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'username', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'DateIn', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'DateOut', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'Teacher', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'sy', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'itemNo', 9, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'question', 10, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'answer', 11, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'a', 12, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'b', 13, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'c', 14, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'actqst', 'd', 15, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admin', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'system', 'admin', 'username', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', 'UNI', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admin', 'password', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admin', 'fn', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admin', 'ln', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admin', 'mi', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admin', 'bday', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admin', 'address', 8, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admin', 'contact', 9, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admin', 'email', 10, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admin', 'pic', 11, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admin', 'UserType', 12, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admins', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'system', 'admins', 'username', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admins', 'password', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admins', 'fn', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admins', 'ln', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admins', 'mi', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admins', 'bday', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admins', 'contact', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admins', 'address', 9, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admins', 'email', 10, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admins', 'pic', 11, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admins', 'UserType', 12, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'admins', 'dateReg', 13, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'lesson', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'system', 'lesson', 'username', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'lesson', 'teacher', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'lesson', 'title', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'lesson', 'subject', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'lesson', 'file', 6, NULL, 'YES', 'varchar', 150, 150, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(150)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'lesson', 'date', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'lesson', 'LesNo', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mp4', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'system', 'mp4', 'LesNo', 2, NULL, 'NO', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mp4', 'title', 3, NULL, 'NO', 'varchar', 150, 150, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(150)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mp4', 'file', 4, NULL, 'NO', 'varchar', 150, 150, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(150)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'lrn', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'username', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'fn', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'ln', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'mi', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'bday', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'contact', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'address', 9, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'email', 10, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'mother', 11, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'father', 12, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'adviser', 13, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'teacher', 14, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'picture', 15, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'mystudents', 'sy', 16, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'QzID', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'QzNo', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'DateIn', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'DateOut', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'username', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'Teacher', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'sy', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'question', 9, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'answer', 10, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'itemNo', 11, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'a', 12, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'b', 13, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'c', 14, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quest', 'd', 15, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quiz', 'QzID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'system', 'quiz', 'QzNo', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', 'UNI', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quiz', 'DateIn', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quiz', 'DateOut', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quiz', 'NoItems', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quiz', 'username', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quiz', 'Teacher', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quiz', 'sy', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'quiz', 'Lesson', 9, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'sections', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'system', 'sections', 'section', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'stdqz', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
(NULL, 'system', 'stdqz', 'QzID', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'stdqz', 'QzNo', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'stdqz', 'username', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'stdqz', 'DateIn', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'stdqz', 'Teacher', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'stdqz', 'sy', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'stdqz', 'a', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'stdqz', 'itemNo', 9, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'stdqz', 'answer', 10, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'lrn', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'username', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'password', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'fn', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'ln', 6, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'mi', 7, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'bday', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'contact', 9, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'address', 10, NULL, 'NO', 'varchar', 150, 150, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(150)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'email', 11, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'mother', 12, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'father', 13, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'guidance', 14, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'grade', 15, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'adviser', 16, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'teacher', 17, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'picture', 18, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'status', 19, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'UserType', 20, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'sy', 21, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'dateEncoded', 22, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'students', 'section', 23, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'username', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'password', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'fn', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'ln', 5, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'mi', 6, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'bday', 7, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'contact', 8, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'address', 9, NULL, 'NO', 'varchar', 150, 150, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(150)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'pic', 10, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'subject', 11, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'sy', 12, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'UserType', 13, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'status', 14, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'system', 'teachers', 'dateReg', 15, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', '');
...
('HANDLER_READ_KEY', '234'),
('HANDLER_READ_NEXT', '34'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '7'),
('HANDLER_READ_RND_NEXT', '1990'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '58'),
('HANDLER_WRITE', '1404'),
('INNODB_BUFFER_POOL_PAGES_DATA', '29'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '1'),
('INNODB_BUFFER_POOL_PAGES_FREE', '483'),
('INNODB_BUFFER_POOL_PAGES_MISC', '0'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '512'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '1'),
('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '852'),
...
('THREAD_CACHE_SIZE', '0'),
('LANGUAGE', 'c:\\wamp\\bin\\mysql\\mysql5.1.32\\share\\english\\'),
...
('PROFILING', 'OFF'),
('THREAD_STACK', '196608'),
('PLUGIN_DIR', 'c:\\wamp\\bin\\mysql\\mysql5.1.32\\lib/plugin'),
('OPEN_FILES_LIMIT', '755'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('EVENT_SCHEDULER', 'OFF'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.32\\data\\JRavino.log'),
('SLAVE_COMPRESSED_PROTOCOL', 'OFF'),
('LARGE_FILES_SUPPORT', 'ON'),
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.32\\data\\JRavino.pid'),
...
('SQL_LOG_OFF', 'OFF'),
('SYNC_FRM', 'ON'),
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.32\\data\\JRavino-slow.log'),
('TIMESTAMP', '1688095235'),
...
(NULL, 'mysql', 'PRIMARY', NULL, 'mysql', 'admins', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'mysql', 'PRIMARY', NULL, 'mysql', 'admins', 'username', 2, NULL, NULL, NULL, NULL),
...
(NULL, 'sample', 'PRIMARY', NULL, 'sample', 'product', 'ID', 1, NULL, NULL, NULL, NULL),
(NULL, 'sample', 'PRIMARY', NULL, 'sample', 'yamino', 'ID', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'actanswer', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'activities', 'ActID', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'actqst', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'admin', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'username', NULL, 'system', 'admin', 'username', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'admins', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'admins', 'username', 2, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'lesson', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'mp4', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'mystudents', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'mystudents', 'lrn', 2, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'quest', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'quiz', 'QzID', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'QzNo', NULL, 'system', 'quiz', 'QzNo', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'QzNo_2', NULL, 'system', 'quiz', 'QzNo', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'sections', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'stdqz', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'students', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'students', 'lrn', 2, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'students', 'username', 3, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'teachers', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'system', 'PRIMARY', NULL, 'system', 'teachers', 'username', 2, NULL, NULL, NULL, NULL);
...
(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'admins', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2023-06-27 06:39:15', NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2008-11-15 01:31:31', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2008-11-15 01:31:31', '2008-11-14 18:31:32', '2008-11-15 01:31:32', NULL, '', '', NULL),
(NULL, 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2008-11-15 01:31:31', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2008-11-15 01:31:31', '2008-11-14 18:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 450, 197, 88650, 55450570411999231, 16384, 0, '2008-11-15 01:31:32', '2008-11-14 18:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 975, 9, 8775, 2533274790395903, 16384, 0, '2008-11-15 01:31:32', '2008-11-14 18:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 497, 812, 403852, 281474976710655, 20480, 0, '2008-11-15 01:31:31', '2008-11-14 18:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2008-11-15 01:31:31', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162411061562048511, 1024, 0, '2008-11-15 01:31:31', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2008-11-15 01:31:31', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2008-11-15 01:31:31', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 52, 152, 281474976710655, 2048, 48, '2008-11-15 01:31:31', '2009-03-06 17:08:32', NULL, NULL, '', '', NULL),
(NULL, 'sample', 'product', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 78, 708, 281474976710655, 2048, 0, '2023-01-18 08:33:22', '2023-01-18 08:33:22', NULL, NULL, '', '', NULL),
(NULL, 'sample', 'yamino', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 68, 272, 281474976710655, 2048, 0, '2023-01-18 08:33:22', '2023-01-18 08:33:22', NULL, NULL, '', '', NULL),
(NULL, 'system', 'actanswer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2023-06-27 06:40:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'system', 'activities', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, 1489, 16384, NULL, 0, 0, '2023-06-27 06:40:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'system', 'actqst', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 20, 819, 16384, NULL, 0, 0, '2023-06-27 06:40:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'system', 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 16384, 0, '2023-06-27 06:40:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'system', 'admins', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2023-06-27 06:40:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'system', 'lesson', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2023-06-27 06:40:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'system', 'mp4', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2023-06-27 06:40:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'system', 'mystudents', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2023-06-27 06:40:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'system', 'quest', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25, 655, 16384, NULL, 0, 0, '2023-06-27 06:40:35', NULL, NULL, NULL, '', '', NULL),
(NULL, 'system', 'quiz', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 32768, 0, '2023-06-27 06:40:35', NULL, NULL, NULL, '', '', NULL),
(NULL, 'system', 'sections', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2023-06-27 06:40:35', NULL, NULL, NULL, '', '', NULL),
(NULL, 'system', 'stdqz', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 0, 0, '2023-06-27 06:40:35', NULL, NULL, NULL, '', '', NULL),
(NULL, 'system', 'students', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2023-06-27 06:40:35', NULL, NULL, NULL, '', '', NULL),
(NULL, 'system', 'teachers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2023-06-27 06:40:35', NULL, NULL, NULL, '', '', NULL);
...
('binlog', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50132.0', NULL, NULL, 'MySQL AB', 'This is a pseudo storage engine to represent the binlog in a transaction', 'GPL'),
('MEMORY', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50132.0', NULL, NULL, 'MySQL AB', 'Hash based, stored in memory, useful for temporary tables', 'GPL'),
('MyISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50132.0', NULL, NULL, 'MySQL AB', 'Default engine as of MySQL 3.23 with great performance', 'GPL'),
('MRG_MYISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50132.0', NULL, NULL, 'MySQL AB', 'Collection of identical MyISAM tables', 'GPL'),
('ARCHIVE', '3.0', 'ACTIVE', 'STORAGE ENGINE', '50132.0', NULL, NULL, 'Brian Aker, MySQL AB', 'Archive storage engine', 'GPL'),
('BLACKHOLE', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50132.0', NULL, NULL, 'MySQL AB', '/dev/null storage engine (anything you write to it disappears)', 'GPL'),
('CSV', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50132.0', NULL, NULL, 'Brian Aker, MySQL AB', 'CSV storage engine', 'GPL'),
('InnoDB', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50132.0', NULL, NULL, 'Innobase OY', 'Supports transactions, row-level locking, and foreign keys', 'GPL'),
('partition', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50132.0', NULL, NULL, 'Mikael Ronstrom, MySQL AB', 'Partition Storage Engine Helper', 'GPL'),
('FEDERATED', '1.0', 'DISABLED', 'STORAGE ENGINE', '50132.0', NULL, NULL, 'Patrick Galbraith and Brian Aker, MySQL AB', 'Federated MySQL storage engine', 'GPL');
...
(9, 'root', 'localhost:64509', 'information_schema', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(4, 'root', 'localhost:64306', 'system', 'Sleep', 405, '', NULL),
(3, 'root', 'localhost:64295', 'system', 'Sleep', 468, '', NULL),
(2, 'root', 'localhost:64294', 'system', 'Sleep', 488, '', NULL),
(1, 'root', 'localhost:64288', 'system', 'Sleep', 377, '', NULL);
...
(NULL, 'senior', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'system', 'latin1', 'latin1_swedish_ci', NULL);
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2124'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2212'),
('INNODB_BUFFER_POOL_PAGES_DATA', '40'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '1'),
...
('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '2381'),
...
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '2838528'),
('INNODB_DATA_READS', '50'),
('INNODB_DATA_WRITES', '7'),
('INNODB_DATA_WRITTEN', '35328'),
('INNODB_DBLWR_PAGES_WRITTEN', '1'),
('INNODB_DBLWR_WRITES', '1'),
...
(NULL, 'mysql', 'admins', 0, 'mysql', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mysql', 'admins', 0, 'mysql', 'PRIMARY', 2, 'username', 'A', 0, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'sample', 'product', 0, 'sample', 'PRIMARY', 1, 'ID', 'A', 9, NULL, NULL, '', 'BTREE', ''),
(NULL, 'sample', 'yamino', 0, 'sample', 'PRIMARY', 1, 'ID', 'A', 4, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'actanswer', 0, 'system', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'activities', 0, 'system', 'PRIMARY', 1, 'ActID', 'A', 11, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'actqst', 0, 'system', 'PRIMARY', 1, 'id', 'A', 20, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'admin', 0, 'system', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'admin', 0, 'system', 'username', 1, 'username', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'admins', 0, 'system', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'admins', 0, 'system', 'PRIMARY', 2, 'username', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'lesson', 0, 'system', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'mp4', 0, 'system', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'mystudents', 0, 'system', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'mystudents', 0, 'system', 'PRIMARY', 2, 'lrn', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'quest', 0, 'system', 'PRIMARY', 1, 'id', 'A', 25, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'quiz', 0, 'system', 'PRIMARY', 1, 'QzID', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'quiz', 0, 'system', 'QzNo', 1, 'QzNo', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'quiz', 0, 'system', 'QzNo_2', 1, 'QzNo', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'sections', 0, 'system', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'stdqz', 0, 'system', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'students', 0, 'system', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'students', 0, 'system', 'PRIMARY', 2, 'lrn', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'students', 0, 'system', 'PRIMARY', 3, 'username', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'teachers', 0, 'system', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'system', 'teachers', 0, 'system', 'PRIMARY', 2, 'username', 'A', 1, NULL, NULL, '', 'BTREE', '');
...
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, 'utf8_general_ci', NULL, 'max_rows=4560', ''),
...
(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
...
(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, 'utf8_general_ci', NULL, 'max_rows=5612', ''),
(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, 'utf8_general_ci', NULL, 'max_rows=13025', ''),
(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, 'utf8_general_ci', NULL, 'max_rows=23763', ''),
...
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, 'utf8_general_ci', NULL, 'max_rows=588', ''),
...
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
...
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2023-06-30 11:20:35', '2023-06-30 11:20:35', NULL, 'utf8_general_ci', NULL, 'max_rows=6932', ''),
(NULL, 'mysql', 'admins', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 3145728, 1, '2023-06-27 06:39:15', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2008-11-15 01:31:31', '2008-11-14 18:31:32', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2008-11-15 01:31:31', '2008-11-14 18:31:32', '2008-11-15 01:31:32', 'utf8_bin', NULL, '', 'Database privileges'),
(NULL, 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, 'utf8_general_ci', NULL, '', 'Events'),
(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2008-11-15 01:31:31', '2008-11-14 18:31:32', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
(NULL, 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2008-11-15 01:31:31', '2008-11-14 18:31:34', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 450, 197, 88650, 55450570411999231, 16384, 0, NULL, '2008-11-15 01:31:32', '2008-11-14 18:31:34', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 975, 9, 8775, 2533274790395903, 16384, 0, NULL, '2008-11-15 01:31:32', '2008-11-14 18:31:34', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 497, 812, 403852, 281474976710655, 20480, 0, NULL, '2008-11-15 01:31:31', '2008-11-14 18:31:34', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2008-11-15 01:31:31', '2008-11-14 18:31:32', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
(NULL, 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162411061562048511, 1024, 0, NULL, '2008-11-15 01:31:31', '2008-11-14 18:31:32', NULL, 'utf8_bin', NULL, '', 'MySQL plugins'),
(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
(NULL, 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2008-11-15 01:31:31', '2008-11-14 18:31:32', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
(NULL, 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2008-11-15 01:31:31', '2008-11-14 18:31:32', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2008-11-15 01:31:32', '2008-11-14 18:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 52, 152, 281474976710655, 2048, 48, NULL, '2008-11-15 01:31:31', '2009-03-06 17:08:32', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
(NULL, 'sample', 'product', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 9, 78, 708, 281474976710655, 2048, 0, 12, '2023-01-18 08:33:22', '2023-01-18 08:33:22', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'sample', 'yamino', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 68, 272, 281474976710655, 2048, 0, 5, '2023-01-18 08:33:22', '2023-01-18 08:33:22', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'system', 'actanswer', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 3145728, 1, '2023-06-27 06:40:34', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'system', 'activities', 'BASE TABLE', 'InnoDB', 10, 'Compact', 11, 1489, 16384, 0, 0, 3145728, 12, '2023-06-27 06:40:34', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'system', 'actqst', 'BASE TABLE', 'InnoDB', 10, 'Compact', 20, 819, 16384, 0, 0, 3145728, 21, '2023-06-27 06:40:34', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'system', 'admin', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 16384, 3145728, 2, '2023-06-27 06:40:34', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'system', 'admins', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 3145728, 2, '2023-06-27 06:40:34', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'system', 'lesson', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 3145728, 5, '2023-06-27 06:40:34', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'system', 'mp4', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 3145728, 2, '2023-06-27 06:40:34', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'system', 'mystudents', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 3145728, 5, '2023-06-27 06:40:34', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'system', 'quest', 'BASE TABLE', 'InnoDB', 10, 'Compact', 25, 655, 16384, 0, 0, 3145728, 26, '2023-06-27 06:40:35', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'system', 'quiz', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 32768, 3145728, 4, '2023-06-27 06:40:35', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'system', 'sections', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 3145728, 5, '2023-06-27 06:40:35', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'system', 'stdqz', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 0, 3145728, 57, '2023-06-27 06:40:35', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'system', 'students', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 3145728, 4, '2023-06-27 06:40:35', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'system', 'teachers', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 3145728, 2, '2023-06-27 06:40:35', NULL, NULL, 'latin1_swedish_ci', NULL, '', '');
...
(NULL, 'mysql', 'PRIMARY', 'mysql', 'admins', 'PRIMARY KEY'),
...
(NULL, 'sample', 'PRIMARY', 'sample', 'product', 'PRIMARY KEY'),
(NULL, 'sample', 'PRIMARY', 'sample', 'yamino', 'PRIMARY KEY'),
(NULL, 'system', 'PRIMARY', 'system', 'actanswer', 'PRIMARY KEY'),
(NULL, 'system', 'PRIMARY', 'system', 'activities', 'PRIMARY KEY'),
(NULL, 'system', 'PRIMARY', 'system', 'actqst', 'PRIMARY KEY'),
(NULL, 'system', 'PRIMARY', 'system', 'admin', 'PRIMARY KEY'),
(NULL, 'system', 'username', 'system', 'admin', 'UNIQUE'),
(NULL, 'system', 'PRIMARY', 'system', 'admins', 'PRIMARY KEY'),
(NULL, 'system', 'PRIMARY', 'system', 'lesson', 'PRIMARY KEY'),
(NULL, 'system', 'PRIMARY', 'system', 'mp4', 'PRIMARY KEY'),
(NULL, 'system', 'PRIMARY', 'system', 'mystudents', 'PRIMARY KEY'),
(NULL, 'system', 'PRIMARY', 'system', 'quest', 'PRIMARY KEY'),
(NULL, 'system', 'PRIMARY', 'system', 'quiz', 'PRIMARY KEY'),
(NULL, 'system', 'QzNo', 'system', 'quiz', 'UNIQUE'),
(NULL, 'system', 'QzNo_2', 'system', 'quiz', 'UNIQUE'),
(NULL, 'system', 'PRIMARY', 'system', 'sections', 'PRIMARY KEY'),
(NULL, 'system', 'PRIMARY', 'system', 'stdqz', 'PRIMARY KEY'),
(NULL, 'system', 'PRIMARY', 'system', 'students', 'PRIMARY KEY'),
(NULL, 'system', 'PRIMARY', 'system', 'teachers', 'PRIMARY KEY');
...
INSERT INTO `product` (`ID`, `productname`, `productprice`, `description`, `image`, `price`) VALUES
(1, 'Sandalphon', 250, 'Sandalphon: (???, lit., "Massacre Ruler")', 'Sandalphon.png', 0),
(2, 'Zadkiel', 200, 'Zadkiel: (????, lit., "Freezing Puppet")', 'Zadkiel.png', 0),
(3, 'Zafkiel', 300, 'Zafkiel: (???, lit., "Emperor of Time")', 'Zafkiel.png', 0),
(4, 'Camael', 240, 'Camael: (????, lit., "Bright Burning Annihilating Demon")', 'Camael.png', 0),
(5, 'Haniel', 240, 'Haniel: (????, lit., "Witch of Forgery")', 'Haniel.png', 0),
(6, 'Gabriel', 270, 'Gabriel: (????, lit., "Army-Breaking Songstress")', 'Gabriel.png', 0),
(8, 'Metatron', 280, 'Metatron:  (????, lit., "Angel of Extinction")', 'Metatron.png', 0),
(9, 'Rasiel', 230, 'Rasiel: (????, lit., "Tome of Revelation")', 'Rasiel.png', 0),
(10, 'Michael', 220, 'Michael: (???, lit., "Seal-Removing Lord")', 'Michael.png', 0);

-- --------------------------------------------------------

--
-- Table structure for table `yamino`
--

CREATE TABLE IF NOT EXISTS `yamino` (
...
--
-- Dumping data for table `yamino`
--

INSERT INTO `yamino` (`ID`, `username`, `password`, `firstname`, `lastname`, `birthday`, `email`) VALUES
(1, 'yamino', '123', 'Reybie', 'Saminado', '10/08/04', 'saminado49@gmail.com'),
(2, 'raiyto', '123', 'Bhieboy', 'Saminado', '10/08/04', 'Inside her heart@gmail.com'),
(3, 'yuta', '123', 'yuta', 'okkotsu', 'Jun 26, 1998', 'yuuyuyuta@gmail.com'),
(4, 'saminado', '1563', 'Reybie', 'Saminado', '07/15/20', 'saminado49@gmail.com');
--
-- Database: `senior`
--
CREATE DATABASE `senior` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `senior`;
...
--
-- in use(#1146 - Table 'senior.attendance' doesn't exist)
...
--
-- in use(#1146 - Table 'senior.faq' doesn't exist)
...
--
-- in use(#1146 - Table 'senior.grades' doesn't exist)
...
--
-- Table structure for table `non_grades`
--
-- in use(#1146 - Table 'senior.non_grades' doesn't exist)

--
-- Dumping data for table `non_grades`
--
...
--
-- in use(#1146 - Table 'senior.sched' doesn't exist)
...
--
-- in use(#1146 - Table 'senior.section' doesn't exist)
...
--
-- in use(#1146 - Table 'senior.stdact' doesn't exist)

--
-- Dumping data for table `stdact`
--
...
--
-- in use(#1146 - Table 'senior.student' doesn't exist)
...
--
-- in use(#1146 - Table 'senior.students' doesn't exist)
...
--
-- in use(#1146 - Table 'senior.subject' doesn't exist)
...
-- Table structure for table `user`
--
-- in use(#1146 - Table 'senior.user' doesn't exist)
...
--
-- in use(#1146 - Table 'senior.values' doesn't exist)
...
-- Database: `system`
--
CREATE DATABASE `system` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `system`;

-- --------------------------------------------------------

--
-- Table structure for table `actanswer`
--

CREATE TABLE IF NOT EXISTS `actanswer` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `username` varchar(45) NOT NULL,
  `ActID` varchar(45) NOT NULL,
  `ActNo` varchar(45) NOT NULL,
...
--
-- Dumping data for table `actanswer`
--
...
INSERT INTO `activities` (`ActID`, `ActNo`, `DateIn`, `DateOut`, `NoItems`, `username`, `Teacher`, `sy`, `Lesson`) VALUES
(1, '1', '06/24/2023', '06/30/2023', '10', 'jofer', 'joferson V  Ravino', '2022-2023', 'Lesson 1.1'),
(2, '2', '06/24/2023', '06/30/2023', '10', 'jofer', 'joferson V Ravino', '2022-2023', 'Lesson 1.2'),
(3, '3', '06/24/2023', '06/30/2023', '10', 'jofer', 'joferson V Ravino', '2022-2023', 'Lesson 1.3'),
(4, '4', '06/24/2023', '06/30/2023', '5', 'jofer', 'joferson V Ravino', '2022-2023', 'Lesson 2.1'),
(5, '5', '06/24/2023', '06/30/2023', '5', 'jofer', 'joferson V Ravino', '2022-2023', 'Lesson 2.2'),
(6, '6', '06/24/2023', '06/30/2023', '3', 'jofer', 'joferson V Ravino', '2022-2023', 'Lesson 2.3'),
(7, '7', '06/24/2023', '06/30/2023', '5', 'jofer', 'joferson V Ravino', '2022-2023', 'Lesson 3.1'),
(8, '8', '06/24/2023', '06/30/2023', '5', 'jofer', 'joferson V Ravino', '2022-2023', 'Lesson 3.2'),
(9, '9', '06/24/2023', '06/30/2023', '10', 'jofer', 'joferson V Ravino', '2022-2023', 'Lesson 3.3'),
(10, '10', '06/24/2023', '06/30/2023', '10', 'jofer', 'joferson V Ravino', '2022-2023', 'Lesson 3.4'),
(11, '11', '06/24/2023', '06/30/2023', '8', 'jofer', 'joferson V Ravino', '2022-2023', 'Lesson 3.5');

-- --------------------------------------------------------

--
-- Table structure for table `actqst`
--

CREATE TABLE IF NOT EXISTS `actqst` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ActID` varchar(45) NOT NULL,
  `ActNo` varchar(45) NOT NULL,
  `username` varchar(45) NOT NULL,
...
--
-- Dumping data for table `actqst`
--

INSERT INTO `actqst` (`id`, `ActID`, `ActNo`, `username`, `DateIn`, `DateOut`, `Teacher`, `sy`, `itemNo`, `question`, `answer`, `a`, `b`, `c`, `d`) VALUES
(1, '1', '1', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '10', '1. How many digits does the number 12345 have? ', 'D', 'One', 'Two', 'Three', 'Four'),
(2, '1', '1', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '10', '2. What are the digits of 678?', 'C', '1,2,3', '2,4,6', '6,7,8', '7,8,9'),
(3, '1', '1', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '10', '3. How many digits does the number 9876543219 have?', 'C', 'Eight', 'Nine', 'Ten', 'Eleven'),
(4, '1', '1', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '10', '4. What are the digits of 9876?', 'C', '3,5,7,9', '4,6,7,8', '6,7,8,9', '7,8,9,10'),
(5, '1', '1', 'jofer', '06/24/2023', '06/302023', 'joferson V Ravino', '2022-2023', '10', '5. How many digits does the number 98765432109876543210 have? ', 'B', 'Ten', 'Twenty', 'Thirty', 'Forty'),
(6, '1', '1', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '10', '6. What are the digits of 54321?', 'D', '1,2,3,4,5', '2,4,6,8,10', '3,4,5,6,7', '4,5,3,2,1'),
(7, '1', '1', 'jofer', '06/24/2023', '06/30/2023', 'jofer', '2022-2023', '10', '7. How many digits does the number 1000000000 have? ', 'D', 'One', 'Eight', 'Nine', 'Ten'),
(8, '1', '1', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '10', '8. What are the digits of 87654321?', 'A', '1,2,3,4,5,6,7,8,', '2,4,6,8,10,12,14,16', '4,5,6,7,8,9,10,11', '6,7,8,9,10,11,12,13'),
(9, '1', '1', 'joer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '10', '9. How many digits does the number 1000000000000000000000000000000 have? ', 'C', '30', '40', '50', '60'),
(10, '1', '1', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '10', '10. What are the digits of 246810?', 'B', '1, 2, 3, 4, 5, 6 ', '2, 4, 6, 8, 10, 12 ', '4, 6, 8, 10, 12, 14 ', '2, 4, 6, 8, 0, 1 '),
(11, '2', '2', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '10', '1. 7 Hundred', 'A', '700', '70000', '70', '7000'),
(12, '2', '2', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '10', '2. 7 Thousands', 'A', '7000', '70', '700', '70000'),
(13, '2', '2', 'jofer', '06/24/2023', '06/30/2023', 'joferson V ravino', '2022-2023', '10', '3. 7 Tens', 'B', '7', '70', '700', '70000'),
(14, '2', '2', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '10', '4. 7 ones', 'D', '7000', '70000', '70', '7'),
(15, '2', '2', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '10', '5. 70 Thousands', 'A', '70000', '700', '7000', '70'),
(16, '2', '2', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '5', '1. 122', 'D', 'TH', 'H', 'T', 'O'),
(17, '2', '2', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '5', '2. 20', 'C', 'TH', 'H', 'T', 'O'),
(18, '2', '2', 'jofer ', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '5', '3. 273', 'B', 'TH', 'H', 'T', 'O'),
(19, '2', '2', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '5', '4. 7249', 'B', 'TH', 'H', 'T', 'O'),
(20, '2', '2', 'jofer', '06/24/2023', '06/30/2023', 'joferson V Ravino', '2022-2023', '5', '5. 2000', 'A', 'TH', 'H', 'T', 'O');
...
INSERT INTO `admin` (`id`, `username`, `password`, `fn`, `ln`, `mi`, `bday`, `address`, `contact`, `email`, `pic`, `UserType`) VALUES
(1, 'Admin01', 'AdminTest01', 'Pauline Joy', 'Abiertas', 'E.', '12/24/1999', '54 Cotabato Street Batasan Hills, Quezon City', '09214908466', 'qpaulinejoy@gmail.com', 'blank.jpg', '1');
...
INSERT INTO `admins` (`id`, `username`, `password`, `fn`, `ln`, `mi`, `bday`, `contact`, `address`, `email`, `pic`, `UserType`, `dateReg`) VALUES
(1, 'admin', '123456', 'Pauline Joy', 'Abiertas', 'E,', '12/24/1999', '09214908466', '54 Cotabato Street Batasan Hills, Quezon City', 'qpaulinejoy@gmail.com', 'blank.jpg', 1, '');
...
INSERT INTO `lesson` (`id`, `username`, `teacher`, `title`, `subject`, `file`, `date`, `LesNo`) VALUES
(4, 'jofer', 'joferson V Ravino', 'Place Value Numeration System', 'asd', 'LESSON 1 PART 1.mp4', '06-26-2023', 'Lesson 1');
...
INSERT INTO `mp4` (`id`, `LesNo`, `title`, `file`) VALUES
(1, 'Lesson 1', 'Place Value Numeration System', 'LESSON 1 PART 1.mp4');
...
INSERT INTO `mystudents` (`id`, `lrn`, `username`, `fn`, `ln`, `mi`, `bday`, `contact`, `address`, `email`, `mother`, `father`, `adviser`, `teacher`, `picture`, `sy`) VALUES
(3, '2234567890', 'jofer', 'Dianne', 'Prollamante', 'N/A', 'N/A', '09566324810', 'N/A', 'dianneprollamante24@gmail.com', 'N/A', 'N/A', 'Jena T. Temena', 'Jena T. Temena', 'Dianne.jpg', '2022-2023'),
(4, '1234567890', 'jofer', 'Jaylou', 'Alarcio', 'P.', 'N/A', '09632031327', 'N/A', 'jaylouponalrico@gmail.com', 'N/A', 'N/A', 'Jena T. Temena', 'Jena T. Temena', 'Jaylou.jpg', '2022-2023');
...
CREATE TABLE IF NOT EXISTS `quest` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `QzID` varchar(45) NOT NULL,
  `QzNo` varchar(45) NOT NULL,
  `DateIn` varchar(45) NOT NULL,
  `DateOut` varchar(45) NOT NULL,
  `username` varchar(45) NOT NULL,
  `Teacher` varchar(45) NOT NULL,
...
INSERT INTO `quest` (`id`, `QzID`, `QzNo`, `DateIn`, `DateOut`, `username`, `Teacher`, `sy`, `question`, `answer`, `itemNo`, `a`, `b`, `c`, `d`) VALUES
(1, '1', '1', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '1. How many digits does the number 2122 have?', 'D', 10, '1', '2', '3', '4'),
(2, '1', '1', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '2. What is the value of the digit 1 in the nu', 'C', 10, '1 ones or one', '1 tens or elevens', '1 hundreds or one hundred', '1 one thousands or one thousand'),
(3, '1', '1', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '3. In which number does 5 have the greatest v', 'D', 10, '5 ones', '5 tens', '5 hundreds', '5 thousands'),
(4, '1', '1', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '4. What is four plus five?', 'C', 10, 'five', 'four', 'nine', 'Fifty-four'),
(5, '1', '1', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '5. What is the total of 13 and 4?', 'A', 10, '17', '21', '24', '28'),
(6, '1', '1', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '6. Ana and Mary  rode a tricycle. Ana fare is 12 pesos, while Mary fare is 13 pesos. How much do they have to pay in all?', 'B', 10, '24 Pesos', '25 Peson', '26 Pesos', '27 Pesos'),
(7, '1', '1', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '7.Aling Lucy  wants to buy some vegetables  for her children. She plans to buy 4 sweet potatoes , 6 carrots and 8 corns. How many vegetables will she have in all? ', 'A', 10, '18 Vegetables', '21 Vegetables', '24 Vegetables', '29 Vegetables'),
(8, '1', '1', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '8. What is 7 minus 2?', 'B', 10, '9', '5', '27', '72'),
(9, '1', '1', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '9. There are 12 toys in the playroom. If someone borrowed\r\nTwo toys , how many would be left?', 'C', 10, '10', '9', '8', '7'),
(10, '1', '1', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '10. Mang Kanor bought 12 cans of milk. He gave 5 milks to his\r\nsister, 4 to his brother and 3 to his neighbor. How many cans of milk were left?', 'B', 10, '5', '4', '3', '0'),
(11, '2', '2', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '1. Given: 35,69; Hundreds: _ , _ , 1;  Tens: 3 , _ , 0; Ones: _ , 9 , 4', 'A', 5, '5 , 6 , 1 , 1', '4 , 6 , 1 , 1', '1 , 0 , 4 , 1', '1 , 2 , 3 , 4'),
(12, '2', '2', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '2. Given: 172, 250; Hundreds: _ , 2 , 3; Tens: 7 , _ , 2; Ones: 2 , _ , 2', 'A', 5, '3 , 5 , 1', '5 , 1 , 4', '1 , 5 , 3', '4 , 5 , 5'),
(13, '2', '2', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '3. Given: 367, 71, 25; Hundreds: 3 , _ , _, 4; Tens: 6 , 7 ,  _ , 6; Ones: _ , 1 , 5 ,  _', 'C', 5, '7 , 3 , 2 , 3', '7 , 2 , 2 , 1', '7 , 2 , 3 , 1', '7 , 1 , 3 , 1'),
(14, '2', '2', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '4. Rovic is preparing bottles for recycling. He has 27 clear bottles,16  green bottles and 49  brown bottles. How many bottles does he have in all? Solution : 2_ + _6 + __ = 92', 'C', 5, '7 , 1 , 29', '7 , 2 , 39', '7 , 1 , 49', '7 , 1 , 19'),
(15, '2', '2', '06/24/2023', '06/302023', 'jofer', 'joferson V Ravino', '2022-2023', '5. Dezza collected different kinds of books for the street children in her community. She got 49 storybooks, 20 math books and 17 science books. How many books did she collect? Solution: 4_ + 2_ + _7 = 8_', 'D', 5, '9 , 0 ,1 , 3', '9 , 0 ,1 , 4', '9 , 0 ,1 , 5', '9 , 0 ,1 , 6'),
(16, '3', '3', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '1. 989 - 838 = ?', 'C', 10, '1872', '1827', '151', '115'),
(17, '3', '3', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '2. 176 - 39 = ?', 'B', 10, '136', '137', '215', '216'),
(18, '3', '3', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '3. 550 - 356 = ?', 'A', 10, '194', '206', '207', '195'),
(19, '3', '3', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '4. 87 - 79 = ?', 'D', 10, '5', '6', '7', '8'),
(20, '3', '3', '06/24/2023', '06/302023', 'jofer', 'joferson V Ravino', '2022-2023', '5. 123 - 71 = ?', 'D', 10, '50', '194', '193', '52'),
(21, '3', '3', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '6. 300 - 59 = ?', 'A', 10, '241', '214', '341', '141'),
(22, '3', '3', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '7. 278 - 9 = ?', 'B', 10, '296', '269', '196', '169'),
(23, '3', '3', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '8. 120 - 105 = ?', 'B', 10, '10', '15', '20', '25'),
(24, '3', '3', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '9. 345 - 199 = ?', 'A', 10, '146', '246', '164', '264'),
(25, '3', '3', '06/24/2023', '06/30/2023', 'jofer', 'joferson V Ravino', '2022-2023', '10. 1000 - 599 = ?', 'B', 10, '400', '401', '402', '403');
...
CREATE TABLE IF NOT EXISTS `quiz` (
  `QzID` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `QzNo` varchar(45) NOT NULL,
  `DateIn` varchar(45) NOT NULL,
  `DateOut` varchar(45) NOT NULL,
  `NoItems` varchar(45) NOT NULL,
  ...
  `Lesson` varchar(45) NOT NULL,
  PRIMARY KEY (`QzID`),
  UNIQUE KEY `QzNo` (`QzNo`),
  UNIQUE KEY `QzNo_2` (`QzNo`)
...
INSERT INTO `quiz` (`QzID`, `QzNo`, `DateIn`, `DateOut`, `NoItems`, `username`, `Teacher`, `sy`, `Lesson`) VALUES
(1, '1', '06/24/2023', 'July 01. 2023 09:0:00 AM', '10', 'jofer', 'joferson V Ravino', '2022-2023', 'Lesson 1'),
(2, '2', '06/24/2023 ', 'July 01. 2023 08:50:00 AM', '10', 'jofer', 'joferson V Ravino', '2022-2023', 'Lesson 2'),
(3, '3', '06/24/2023', 'June 29. 2023 08:50:00 AM', '10', 'jofer', 'joferson V Ravino', '2022-2023', 'Lesson 3');
...
--
-- Table structure for table `stdqz`
--

CREATE TABLE IF NOT EXISTS `stdqz` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `QzID` varchar(45) NOT NULL,
  `QzNo` varchar(45) NOT NULL,
  `username` varchar(45) NOT NULL,
...
--
-- Dumping data for table `stdqz`
--

INSERT INTO `stdqz` (`id`, `QzID`, `QzNo`, `username`, `DateIn`, `Teacher`, `sy`, `a`, `itemNo`, `answer`) VALUES
(47, '1', '1', 'jofer', '06/24/2023', 'joferson V Ravino', '2022-2023', 'A', '10', 'D'),
(48, '2', '1', 'jofer', '06/24/2023', 'joferson V Ravino', '2022-2023', 'B', '10', 'C'),
(49, '3', '1', 'jofer', '06/24/2023', 'joferson V Ravino', '2022-2023', 'C', '10', 'D'),
(50, '4', '1', 'jofer', '06/24/2023', 'joferson V Ravino', '2022-2023', 'B', '10', 'C'),
(51, '5', '1', 'jofer', '06/24/2023', 'joferson V Ravino', '2022-2023', 'C', '10', 'A'),
(52, '6', '1', 'jofer', '06/24/2023', 'joferson V Ravino', '2022-2023', 'A', '10', 'B'),
(53, '7', '1', 'jofer', '06/24/2023', 'joferson V Ravino', '2022-2023', 'C', '10', 'A'),
(54, '8', '1', 'jofer', '06/24/2023', 'joferson V Ravino', '2022-2023', 'C', '10', 'B'),
(55, '9', '1', 'jofer', '06/24/2023', 'joferson V Ravino', '2022-2023', 'A', '10', 'C'),
(56, '10', '1', 'jofer', '06/24/2023', 'joferson V Ravino', '2022-2023', 'C', '10', 'B');
...
CREATE TABLE IF NOT EXISTS `students` (
  ...
  `UserType` int(11) NOT NULL,
  `sy` varchar(45) NOT NULL,
  `dateEncoded` varchar(45) NOT NULL,
  `section` varchar(45) NOT NULL,
  PRIMARY KEY (`id`,`lrn`,`username`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;
...
INSERT INTO `students` (`id`, `lrn`, `username`, `password`, `fn`, `ln`, `mi`, `bday`, `contact`, `address`, `email`, `mother`, `father`, `guidance`, `grade`, `adviser`, `teacher`, `picture`, `status`, `UserType`, `sy`, `dateEncoded`, `section`) VALUES
(1, 1234567890, 'Jaylou', 'Alarcio', 'Jaylou', 'Alarcio', 'P.', 'N/A', '09632031327', 'N/A', 'jaylouponalrico@gmail.com', 'N/A', 'N/A', 'none', 'ALS', 'Jena T. Temena', 'Jena T. Temena', 'Jaylou.jpg', 'Active', 0, '2022-2023', '06/13/2023', 'ALS'),
(2, 2234567890, 'Dianne', 'Prollamante', 'Dianne', 'Prollamante', 'N/A', 'N/A', '09566324810', 'N/A', 'dianneprollamante24@gmail.com', 'N/A', 'N/A', 'None', 'ALS', 'Jena T. Temena', 'Jena T. Temena', 'Dianne.jpg', 'Active', 0, '2022-2023', '06/13/2023', 'ALS'),
(3, 4294967295, 'jofer', '123', 'Joferson', 'Ravino', 'V', 'August 5, 1999', '09334858638', 'Batasan Hills Q.C.', 'joferszone@gmail.com', 'Teresa Ravino', 'Mar Ravino', 'None', 'ALS', 'None', 'None', 'blank.jpg', 'Permanent', 0, '2022-2023', 'Today', 'Jupiter');
...
INSERT INTO `teachers` (`id`, `username`, `password`, `fn`, `ln`, `mi`, `bday`, `contact`, `address`, `pic`, `subject`, `sy`, `UserType`, `status`, `dateReg`) VALUES
(1, 'jofer', '123', 'joferson', 'Ravino', 'V', '06/17/2023 June 17th', '09334858638', 'Batasan Hills Q.C.', 'jofer.jpg', 'Programming', '2022-2023', '0', 'Permanent', '2023-06-13');
