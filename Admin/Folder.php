...
<a href="<?php echo $logoutAction ?>">Logout</a>
 ...
 <div class="dropdown">
  ...
  <tr>
    <td height="354" align="center" bgcolor="#FFFFFF"  background="../image/violet.png" ><table width="900" height="136">
      <tr>
        <td width="900">
        
        
<h1>Upload MP4 Files</h1>

<p>
  <label for="file">Select folder</label> 
  to paste MP4 Files</p>
<p>
...
<h2>&nbsp;</h2>
        ...
        <td width="900" align="center"><p>&nbsp;</p>          <?php
echo "<b><u>List of MP4 files in directory folder<u></b>";
echo '<br><br>';
$path = "../MathLessonsMp4";
$dh = opendir($path);
$i=1;
